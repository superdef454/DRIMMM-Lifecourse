...
class University(Base):
    ...
    image: Mapped[str] = mapped_column(ImageType(storage=storage))
...
class Student(Base):
    ...
    def __repr__(self) -> str:
        return f"{self.uid_keycloak_user}"
...
class LegalDocumentAcceptance(Base):
    ...
    def __repr__(self) -> str:
        return f"{self.legal_document_id} - {self.uid_keycloak_user}"
...
class Agent(Base):
    ...
    def __repr__(self) -> str:
        return f"{self.uid_keycloak_user} - {self.post}"
...
class Like(Base):
    ...
    def __repr__(self) -> str:
        return f"{self.uid_keycloak_user} - {self.publication}"
